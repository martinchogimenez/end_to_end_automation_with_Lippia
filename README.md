...
# Purpose
This project has the intention of showing you an end to end automation testing suite case, using Lippia Automation Framework by using Gherkin and Page-Object Model pattern.
...
- # Running with Maven
  ...
  + ### First Step
    ...
    ```
    $ git clone https://github.com/martinchogimenez/end_to_end_automation_with_Lippia.git
    ```
